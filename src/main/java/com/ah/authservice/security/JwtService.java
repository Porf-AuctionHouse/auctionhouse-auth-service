package com.ah.authservice.security;

import com.ah.authservice.model.entity.AppUsers;
import com.ah.authservice.service.CustomUserDetailsService;
...
public class JwtService {
    ...
    public String generateAccessToken(String usernameOrEmail) {
        AppUsers userDetails = customUserDetailsService.loadUserByUsername(usernameOrEmail);
